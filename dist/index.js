...
function StyledComponentsRegistry({ children }) {
  const [styledComponentsStyleSheet] = (0, import_react.useState)(() => new import_styled_components6.ServerStyleSheet());
  ...
  const menager = (sheet) => {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      import_styled_components6.StyleSheetManager,
      {
        sheet,
...
var ThemeProviderContainer = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    ThemeContext.Provider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_styled_components7.ThemeProvider, { theme: Themes[props.theme || defaultTheme], children: props.children })
    }
  );
};
...
var Tooltip = import_styled_components8.default.div`
    position: fixed;
...
var Content = import_styled_components10.default.div`
    padding: 1.5rem;
    display: flex;
    flex-direction: column;
    gap: 1.5rem;
